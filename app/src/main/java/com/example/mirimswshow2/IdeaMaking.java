...
public class IdeaMaking extends AppCompatActivity {
    ...
    String ranWord[]={"유치원","어린이","꽃","벽돌","커튼","전구","창문","시계","피카츄","펭귄","뉴스","교복","청소년"
            ...
            ,"카드","울타리","블라인드","발","밤(night)","신발","눈","이빨","백과사전","과자","상어","초코","다이어리","수첩","장애인"
            ,"테이프","휴지","스태프","행사","부스","전시","학교","머리끈","학생","콘서트","덕질","영어","머리핀","손톱"
            ,"세계","액자","미술관","박물관","소셜","쇼핑","상품","옷","스탠드","독서실","공시생","노량진","카페"
            ,"음식점","고기","회","초밥","바다","산","놀이공원","병아리","집","설계도","이불","남자친구","여자친구","교통사고"
            ,"급식체","오버워치","포스트잇","마분지","벽지","도매","거래","성형","응급실","스프링","캠프","그릇","컴싸","냄비"
            ,"냉장고","밥","티비","노트북","가방고리","파일","자전거","지도","핫팩","땀","숫자","점자","청각장애","시각장애"
            ,"수화","경보음","일요일","주말","압정","졸업","티슈","충전","멀티탭","자동차","기름","주유소","고속도로","나무"
            ...
            ,"자기장","현금","칩","CPU","새","토요일","드라마","촬영","현장","사진","경찰","수사","자료","화상","습관"
            ,"바늘","로봇","커피","수술","곤충","영화","공원","밤(먹는)","연애","배우","사랑","부모님","패션","식물","모피","나뭇가지"
            ,"유리","종이","조형물","얼음","가전","서랍","여자","남자","노인","성향","스피커","마스크","공기","피부","한옥"
            ,"샴푸","욕실","야식","체인점","화살표","피로","양말","만보기","가방","케이스","가족","주방","체육","대결","틀"
            ,"끈","알파벳","어린이집","연금","나라","국민","공유기","꼬리","컵","일회용","간식","책","문제집","단어"
            ,"목재","공","라벨","판매","한정수량","마트","AI","건설","강아지","집사","물고기","규정","비누"};
